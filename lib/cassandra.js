...
Cassandra.prototype.executeSQL = function(cql, params, options, callback) {
  ...
  //Adding Consistency level LOCAL_QUORUM for AWS

  this.client.execute(cql, serialize(params), 
    { prepare : true, readTimeout: 30000, consistency: cassandra.types.consistencies.localQuorum }, myCallback);
};
...
Cassandra.prototype._modifyOrCreate = function(model, data, options, fields, cb) {
  ...
  //Adding Consistency level LOCAL_QUORUM for AWS
  options.consistency = cassandra.types.consistencies.localQuorum;
